...
export class JobContactTypesComponent implements OnInit, OnDestroy {
  ...
  filter: any
  specialColumn: any
  JobContactTypesId: number
  search: string
  showJobContactTypeAddBtn: string = 'hide'
  showJobContactTypeDeleteBtn: string = 'hide'
   ...
   */
  searchJobContactTypes(srch: string) {
